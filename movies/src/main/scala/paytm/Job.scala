...
// mvn exec:exec -Dexec.executable="java" -Dexec.args="-cp %classpath paytm.RunJobLocal 2 file:///some/path file:///some/other/path"
object RunJobLocal {
...
// mvn exec:exec -Dexec.executable="java" -Dexec.args="-cp %classpath paytm.RunJobRemote 2 file:///some/path file:///some/other/path"
object RunJobRemote {
  def main(args: Array[String]) {
    val job = new Job
    if (args.size < 3) {
